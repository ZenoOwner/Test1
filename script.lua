...
-- â”€â”€ HERO HUB INTRO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
task.spawn(function()
...
-- â”€â”€ END INTRO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

-- â”€â”€ ANTI LAG MINI GUI â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
task.spawn(function()
...
-- â”€â”€ END ANTI LAG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function applyTheme(themeName)
    ...
    -- Accent1 e Accent2 sao excluidos â€” sempre ficam roxo
    local colorMap = {}
    ...
    task.spawn(function()
        ...
        -- Atualiza racetrack borders â€” sempre roxo independente do tema
...
task.spawn(function()
    ...
    canUseAdminAction = function(targetPlayer)
        ...
        if isBlacklisted(targetPlayer.Name) then
            ShowNotification("BLACKLIST", "ðŸš« " .. targetPlayer.Name .. " is blacklisted")
            return false
        end
        return true
    end
    ...
    -- â”€â”€ AUTO DESTROY TURRETS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    turretBtn.Text             = Config.AutoDestroyTurrets and "ðŸ”« TURRET: ON" or "ðŸ”« TURRET: OFF"
...
isOnCooldown = function(cmd)
        ...
        if not g and inp.UserInputType == Enum.UserInputType.MouseButton1 and Config.ClickToAP then
            ...
            if bestPlayer then
                ...
                if isBlacklisted(bestPlayer.Name) then
                    ShowNotification("BLACKLIST", "ðŸš« " .. bestPlayer.Name .. " is blacklisted")
                    return
                end
    ...
    local function createPlayerRow(plr)
        ...
        -- â”€â”€ BLACKLIST BUTTON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        blBtn.MouseButton1Click:Connect(function()
            pcall(function()
                if isBlacklisted(plr.Name) then
                    ...
                    ShowNotification("BLACKLIST", "âœ… Removed: " .. plr.Name)
                else
                    addToBlacklist(plr.Name)
                    ShowNotification("BLACKLIST", "ðŸš« Blocked: " .. plr.Name)
                end
                updateBlBtn()
    ...
    Players.PlayerAdded:Connect(function(plr)
        ...
        if plr and plr.Parent then
            addPlayer(plr)
            sortAdminPanelList()
            ShowNotification("ADMIN", "âž• " .. plr.Name .. " entrou")
        end
    end)
...
-- â”€â”€ AUTO DESTROY TURRETS WHEN HOLDING BRAINROT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
task.spawn(function()
    ...
    while true do
        ...
        if holdingBrainrot and not Config.AutoDestroyTurrets then
            ...
            SaveConfig()
            autoEnabled = true
            ShowNotification("AUTO TURRET", "ðŸ”« Brainrot detectado â€” Turret ON")
...
-- â”€â”€ BLACKLIST ESP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
task.spawn(function()
...
task.spawn(function()
    ...
    -- BotÃ£o de tema desativado - substituido pela nova UI
...
function buildHeroSettingsUI()
    ...
    -- â”€â”€â”€ AUTO STEAL DEFAULTS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€â”€ AUTO STEAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- â”€â”€â”€ BINDS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    makeSec(cS, "BINDS", 70)
        ...
        for i, name in ipairs(BlacklistedPlayers) do
            ...
            remBtn.MouseButton1Click:Connect(function()
                pcall(function()
                    ...
                    ShowNotification("BLACKLIST", "âœ… Removed: " .. n)
                    refreshBlacklistUI()
                end)
            end)
        end
    ...
    blAddBtn.MouseButton1Click:Connect(function()
        pcall(function()
            ...
            if addToBlacklist(name) then
                ShowNotification("BLACKLIST", "ðŸš« Blocked: " .. name)
                blBox.Text = ""
                refreshBlacklistUI()
            else
...
function buildMiniActionsUI()
    ...
    lockBtn.Text = Config.MiniUILocked and "ðŸ”’" or "ðŸ”“"
    ...
    -- â”€â”€ AUTO BUY UI + BUTTON â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    -- 4) Circle color row â€” one swatch per theme, 2 rows of 4
    ...
    -- â”€â”€ RING CIRCLE (same pattern as proxViz) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    local abRing = nil
    ...
    local function toggleAutoBuy()
        ...
        ShowNotification("AUTO BUY", autoBuyActive and "âœ… ATIVADO" or "âŒ DESATIVADO")
    end
    ...
    -- â”€â”€ AUTO BUY BACKEND â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    task.spawn(function()
        local Packages = ReplicatedStorage:WaitForChild("Packages")
        local Datas    = ReplicatedStorage:WaitForChild("Datas")
        local Shared   = ReplicatedStorage:WaitForChild("Shared")
        ...
        -- â”€â”€ REMOTE RESOLVER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        -- â”€â”€ FAST + UNDETECTABLE PURCHASE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        -- â”€â”€ CARPET LOCK â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        -- â”€â”€ HOVER: CARPET-BASED, NOT CFRAME TELEPORT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        -- Instead of hard-locking CFrame (detectable), we use the carpet's
        -- natural velocity control to stay above the target.
        -- The carpet already lets the player float â€“ we just point it at
            ...
            while true do
                ...
                if lockedPart or lockedModel then
                    if not partAlive() then
                        ShowNotification("AUTO BUY","ðŸ“¦ Reached base, scanning...")
                        lockedTarget=nil; lockedPart=nil; lockedModel=nil
                    end
                    continue
                end
                ...
                if best then
                    ...
                    ShowNotification("AUTO BUY","ðŸ”’ "..best.name)
                    startCarpetLock()
                end
            end
        end)
...
local function tpToBestBrainrot()
    ...
    if useConv then ShowNotification("TP BEST","ESTEIRA â†’ "..(bestConv.name or "?")); task.spawn(function() local char=LocalPlayer.Character; local hrp=char and char:FindFirstChild("HumanoidRootPart"); local hum=char and char:FindFirstChild("Humanoid"); if not hrp or not hum then return end; local tool=LocalPlayer.Backpack:FindFirstChild(Config.TpSettings.Tool) or char:FindFirstChild(Config.TpSettings.Tool); if tool then hum:EquipTool(tool) end; hrp.AssemblyLinearVelocity=Vector3.new(0,280,0); RunService.Heartbeat:Wait(); hrp.CFrame=CFrame.new(bestConv.part.Position+Vector3.new(0,3,0)) end); return end
    if bestBase then ShowNotification("TP BEST","BASE â†’ "..bestBase.name); SharedState.SelectedPetData={petName=bestBase.name,mpsText=bestBase.genText,mpsValue=bestBase.genValue,owner=bestBase.owner,plot=bestBase.plot,slot=bestBase.slot,uid=bestBase.uid,mutation=bestBase.mutation,animalData=bestBase}; task.spawn(runAutoSnipe)
...
-- â”€â”€ DESYNC VISUALIZER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
task.spawn(function()
