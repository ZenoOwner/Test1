...
-- Initialize scanner â€” called once after game loads
...
if true then -- mobile buttons (always enabled)
    ...
    -- LOCK button â€” no toggle state stored in MobileButtons, just a local
    do
    ...
    print("âœ“ MOBILE BUTTONS: 2 horizontal rows, rectangles, lock button, fixed dragging")
end
...
print("âœ“ Mobile: 2 horizontal rows of rectangle buttons + LOCK button")
print("âœ“ Inf jump fixed for mobile (re-jumps on land)")
print("âœ“ A.LEFT/A.RIGHT auto-reset button when movement completes")
print("âœ“ Drag uses btn.InputChanged - joystick no longer moves buttons")
