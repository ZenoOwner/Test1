...
screenGui.Name = "VonSupreme"
screenGui.ResetOnSpawn = false
screenGui.DisplayOrder = 99999
screenGui.Parent = PlayerGui

local frame = Instance.new("Frame")
frame.Size = UDim2.new(0, 220, 0, 153)
...
progressFill.BackgroundColor3 = Color3.fromRGB(255, 0, 100)
...
local function executeSteal(prompt)
    ...
    status.Text = "STEALING: " .. (prompt.ObjectText or "ITEM")
    firePromptConnections(prompt, "PromptButtonHoldBegan")
    
    progressFill.Size = UDim2.new(0, 0, 1, 0)
    local tween = TweenService:Create(progressFill, TweenInfo.new(stealDelay, Enum.EasingStyle.Linear), {Size = UDim2.new(1, 0, 1, 0)})
    tween:Play()
...
btn.MouseButton1Click:Connect(function()
    ...
    btn.Text = autoStealEnabled and "RUNNING" or "PAUSED"
    btn.BackgroundColor3 = autoStealEnabled and Color3.fromRGB(25, 25, 30) or Color3.fromRGB(50, 20, 20)
    if not autoStealEnabled then
        status.Text = "SYSTEM PAUSED"
        progressFill.Size = UDim2.new(0, 0, 1, 0)
    end
end)
...
discordBtn.BackgroundColor3 = Color3.fromRGB(20, 20, 25)
...
print("no reselling don't be stupid")
